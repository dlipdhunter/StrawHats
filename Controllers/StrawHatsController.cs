...
namespace StrawHats.Controllers {
    ...
    public class StrawHatsController : Controller {
        ...
        private List<PirateModel> StrawHats= new List<PirateModel>{
        ...
        [HttpPost]
        public IActionResult Create([FromBody] PirateModel pirate){
            pirate.Id = StrawHats.Count + 1;
            StrawHats.Add(pirate);
            return Json(StrawHats);
        }
